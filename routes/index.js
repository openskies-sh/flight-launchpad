...
router.post('/submit-declaration', flight_operation_validate, asyncMiddleware(async (req, res, next) => {
    ...
    router.get('/operation-status/:uuid', asyncMiddleware(async (req, res, next) => {
